...
// clear the screen "cls" - MODIFIED: Do nothing to preserve recommendation output
void Chess::clear() const
{
    // Function intentionally left empty to preserve console output
    // Original implementation removed to keep recommended moves visible
}
...
// clear the screen - MODIFIED: Do nothing to preserve recommendation output
void Chess::clear() const
{
    // Function intentionally left empty to preserve console output
    // Original implementation removed to keep recommended moves visible
...
{
    clear();
    cout << "\n\n"; // Add some space to separate from previous output
    show();
